...
const FAQ = {
    like: {
        ...
        resp: (p) => {
            if (p) {
                return [
                    "Me gusta mucho la pizza de " + PIZZAS[p],
    ...
    unlike: {
        ...
        resp: (p) => {
            if (p) {
                return [
                    "Siempre he odiado la pizza de " + PIZZAS[p],
    ...
    last: {
        preg: [
            "¿Cuál fue tu último trozo?",
            "Echame el aliento",
        ],
        resp: (p) => {
            return [
                "Mi último trozo fue de " + PIZZAS[p],
    ...
    exceed: {
        preg: "",
        resp: [
            "Estoy cansado de responderte.", // cambiar segun genero
